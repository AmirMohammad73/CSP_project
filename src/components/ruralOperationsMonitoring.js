...
export function useRuralOperationsMonitoring() {
    ...
    const tabs = ref([
        ...
        "ژئوکد معابر",
        "تخصیص کد پستی و ژئوکد اراضی کشاورزی",
        "تامین لایه نقشه محدوده",
        "تولید لایه نقاط روستایی و تطبیق با مرکز آمار",
        "ساماندهی ساختمانهای بدون پلاک",
        "ساماندهی معابر فاقد نام",
        "استاندارد سازی نشانیها",
        "تطبیق محدوده گشتهای پستی و محدوده",
    ]);
